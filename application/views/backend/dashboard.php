                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    ?>  Employees</h3>
                                        <a href="<?php echo base_url(); ?>employee/Employees" class="text-muted m-b-0">Voir les détails</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url(); ?>leave/Application" class="text-muted m-b-0">Voir les détails</a>
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url(); ?>Projects/All_Projects" class="text-muted m-b-0">Voir les détails</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url(); ?>Loan/View" class="text-muted m-b-0">Voir les détails</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-inverse card-info">
                            <div class="box bg-primary text-center">
                                ...
                                <h6 class="text-white">Anciens employés</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-info card-inverse">
                            <div class="box text-center">
                                ...
                                <h6 class="text-white">Demande d’autorisation en instance</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-inverse card-danger">
                            <div class="box text-center">
                                ...
                                <h6 class="text-white">Projet à venir</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-inverse card-success">
                            <div class="box text-center">
                                ...
                                <h6 class="text-white">Demande de prêt</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Projet en cour/s</h4>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Liste des choses à faire</h4>
                                <h6 class="card-subtitle">Liste de votre prochaine tâche à accomplir</h6>
